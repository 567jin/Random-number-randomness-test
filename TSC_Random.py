...
class Args:
    ...
    def __init__(self) -> None:
        self.batch_size = 512
        self.lr = 0.0005  # 0.001 更好
        self.epochs = 200
        self.device = torch.device(
            "cuda:0" if torch.cuda.is_available() else "cpu")
        self.window = 10  # 数据集长度 即window个长度的序列去预测下一个
        self.slide = 3  # 生成数据集时的滑动步长
        self.last_model_name = r"model\FCN_2_22_lastModel.pth"  # 最后的模型保存路径
        self.best_model_name = r"model\FCN_2_22_bestModel.pth"  # 最好的模型保存路径
        self.file_name = r"dataset\LCG_2_22_10M_Seed5200.bin"  # 文件路径
        ...
        ########################################################################################
        # 修改模型时 一定要修改plot！！！！！！！！#
        self.figPlot_path = r"log\FCN_NoPe_EM32_2_22_10M_20_E200.svg"
        ########################################################################################
...
if __name__ == '__main__':
    ...
    #             64, 64, 128, 128], kernel_size=3, dropout=0.2).cuda()
